// use core::{ptr, slice};
// use crate::{decode_feature_report, read_illuminance};
...
//         let report = unsafe { &*(buffer as *const [u8; 3]) };
//         if decode_feature_report(report) {
//             unsafe { sensor_state.feature_report_updated = true; }
//         }
//     }
// }
//
// // array of pointer to string descriptors
// pub const STRING_DESC_ARR: [&[u8]; 3] = [
